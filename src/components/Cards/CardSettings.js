...
// /**
//  * Component that displays and allows editing of user settings.
//  * It receives user data via a 'user' prop.
//  */
...
//   // This useEffect watches the 'user' prop and loads the data for the form.
//   useEffect(() => {
//     if (user) {
//       try {
//         const localStorageKey = `userProfile_${user._id}`;
//         const userData = localStorage.getItem(localStorageKey);

//         if (userData) {
//           setFormData(JSON.parse(userData));
//         } else {
//           // If no profile data exists, use the base user data from the API
//           const initialData = {
...
//   if (loading || !user) {
//     return <p className="p-8 text-lg">Loading user profile...</p>;
//   }
